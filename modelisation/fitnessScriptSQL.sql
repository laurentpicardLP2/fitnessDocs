...
CREATE TABLE IF NOT EXISTS `db_fitness`.`Command` (
  ...
  `statusCommand` INT NOT NULL,
  `Users_username` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idCommand`),
  CONSTRAINT `fk_Command_Users1`
    FOREIGN KEY (`Users_username`)
    REFERENCES `db_fitness`.`Users` (`username`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_Command_Users1_idx` ON `db_fitness`.`Command` (`Users_username` ASC);
